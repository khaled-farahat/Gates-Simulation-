...
public:
	...
	virtual bool InsideArea(int x1, int y1);
	void SetSrcCmpnt(Component*); //Set Connection source component
	void SetDstCmpnt(Component*); //Set Connection Destination component

	Component* GetSrcCmpnt(); //Set Connection source component
	Component* GetDstCmpnt(); //Get Connection Destination component
